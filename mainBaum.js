...
var $author$project$Baum$init = function (_v0) {
	return _Utils_Tuple2(
		{correlationMatrix: _List_Nil, data: _List_Nil, selectedX: 'Stresslevel', selectedY: 'Schlafdauer', showFemale: true, showMale: true, showPlot: true},
		$author$project$Baum$loadCsv);
};
...
var $author$project$Baum$rowToPerson = function (row) {
			...
			default:
				if (msg.a.$ === 'Ok') {
					...
					if (_v1.$ === 'Ok') {
						...
						var persons = A2($elm$core$List$filterMap, $author$project$Baum$rowToPerson, dataRows);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{data: persons}),
...
var $author$project$Baum$ToggleFemale = function (a) {
	return {$: 'ToggleFemale', a: a};
};
var $author$project$Baum$ToggleMale = function (a) {
	return {$: 'ToggleMale', a: a};
};
var $author$project$Baum$TogglePlot = {$: 'TogglePlot'};
var $author$project$Baum$ChangeX = function (a) {
	return {$: 'ChangeX', a: a};
};
...
var $author$project$Baum$axisSelectX = function (selected) {
	return A2(
		$elm$html$Html$select,
		_List_fromArray(
			[
				$elm$html$Html$Events$onInput($author$project$Baum$ChangeX)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$value('Beruf'),
						$elm$html$Html$Attributes$selected(selected === 'Beruf')
					]),
				_List_fromArray(
					[
...
var $author$project$Baum$ChangeY = function (a) {
	return {$: 'ChangeY', a: a};
};
var $author$project$Baum$axisSelectY = function (selected) {
	return A2(
		$elm$html$Html$select,
		_List_fromArray(
			[
				$elm$html$Html$Events$onInput($author$project$Baum$ChangeY)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Baum$buildGraph = F2(
...
var $author$project$Baum$graphView = function (model) {
	...
	var centerY = 140;
	var centerX = 400;
	var _v0 = A2($author$project$Baum$buildGraph, keys, model.correlationMatrix);
	var nodes = _v0.a;
	var edges = _v0.b;
	var nodeCount = $elm$core$List$length(nodes);
	var nodePos = function (node) {
		var angle = ((2 * $elm$core$Basics$pi) * node.id) / nodeCount;
		return _Utils_Tuple2(
		...
		function (edge) {
			...
			var fromNode = $elm$core$List$head(
				A2(
					...
					nodes));
			var _v2 = _Utils_Tuple2(fromNode, toNode);
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Korrelationsgraph:'),
				A2(
				$elm$svg$Svg$svg,
				_List_fromArray(
					[
				...
				_Utils_ap(
					edgeElements,
					$elm$core$List$concat(nodeElements)))
			]));
};
...
var $author$project$Baum$labelCheckbox = F3(
...
var $author$project$Baum$getValueForAxis = F2(
	function (dp, axis) {
		switch (axis) {
			case 'Schlafdauer':
...
var $author$project$Baum$ticksForAxis = function (axis) {
	switch (axis) {
		case 'Stresslevel':
			return _List_fromArray(
				[0, 2, 4, 6, 8, 10]);
...
var $author$project$Baum$scatterPlotView = function (model) {
	var yTicks = $author$project$Baum$ticksForAxis(model.selectedY);
	var xTicks = $author$project$Baum$ticksForAxis(model.selectedX);
	var plotWidth = 800;
	...
	var xs = A2(
		$elm$core$List$map,
		function (dp) {
			return A2($author$project$Baum$getValueForAxis, dp, model.selectedX);
		},
		filteredData);
	var maxX = A2(
		$elm$core$Maybe$withDefault,
	...
	var ys = A2(
		$elm$core$List$map,
		function (dp) {
			return A2($author$project$Baum$getValueForAxis, dp, model.selectedY);
		},
		filteredData);
	var maxY = A2(
		$elm$core$Maybe$withDefault,
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromFloat(
											scaleX(
												A2($author$project$Baum$getValueForAxis, dp, model.selectedX)))),
										$elm$svg$Svg$Attributes$cy(
										$elm$core$String$fromFloat(
											scaleY(
												A2($author$project$Baum$getValueForAxis, dp, model.selectedY)))),
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Baum$axisSelectX(model.selectedX)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$author$project$Baum$axisSelectY(model.selectedY)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Baum$TogglePlot)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
				...
				_List_fromArray(
					[
						A3($author$project$Baum$labelCheckbox, 'MÄNNER', model.showMale, $author$project$Baum$ToggleMale),
						A3($author$project$Baum$labelCheckbox, 'FRAUEN', model.showFemale, $author$project$Baum$ToggleFemale)
					])),
				model.showPlot ? $author$project$Baum$scatterPlotView(model) : $elm$html$Html$text(''),
				$author$project$Baum$graphView(model),
				$elm$html$Html$text(
				$elm$core$Debug$toString(model.correlationMatrix))
			]));
};
var $author$project$Baum$main = $elm$browser$Browser$element(
	{init: $author$project$Baum$init, subscriptions: $author$project$Baum$subscriptions, update: $author$project$Baum$update, view: $author$project$Baum$view});
