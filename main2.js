			...
			[
				...
				_List_fromArray(
					[
						...
						'background-color',
						(selected === 'Schritte') ? '#87CEEB' : 'white')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'background-color',
						(selected === 'Alkoholkonsum pro Woche') ? '#87CEEB' : 'white')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'background-color',
						(selected === 'Schlafdauer') ? '#87CEEB' : 'white')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'background-color',
						(selected === 'Herzfrequenz') ? '#87CEEB' : 'white')
					]),
				_List_fromArray(
					[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'background-color',
						(selected === 'Kalorienaufnahme') ? '#87CEEB' : 'white')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'background-color',
						(selected === 'Trainingsstunden pro Woche') ? '#87CEEB' : 'white')
					]),
				_List_fromArray(
					[
